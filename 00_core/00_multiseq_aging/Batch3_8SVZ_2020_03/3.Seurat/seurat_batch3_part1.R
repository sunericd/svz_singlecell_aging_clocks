...
barcode.intersect <- intersect(colnames(svz.data), columns_lmo) # 12413
...
svz <- HTODemux(svz, assay = "LMO", positive.quantile = 0.99, nsamples = 1000)
...
ggsave("plots/Supplementary_Figure1b_tsne.lmo.sing.pdf", width = 5.9, height = 4.6)
...
ggsave("plots/Supplementary_Figure1a_heatmap.png", width = 6.9, height=2.88)
...
# More analysis in seurat_batch3_part2.R
