...
#==================================================================================================
# Load human bootstrapped cells

human_data <- readRDS("data/bootstrap_pseudocell_15_human.rds")

meta <- as.data.frame(human_data[, c(1:3)])
umi <- human_data[, -c(1:3)]
...
saveRDS(output, "data/humans_predictions.rds")
