...
ggplot(d, aes(x= minus_Predicted_Fraction, color = Age, fill = Age)) +
    ...
    xlab("35 - Predicted Proliferative %")

ggsave("plots/density_grid_all_bio.pdf", useDingbats=F)
...
ggsave("plots/density_grid_matching_bio.pdf", width = 4.59, height = 2.42,  useDingbats=F)
